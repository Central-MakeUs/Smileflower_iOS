...
class RankingTableViewCell: UITableViewCell {
    static let resueidentifier = "RankingTableViewCell"
    ...
    let imageViewUserGrade = UIImageView()
    ...
    func setimageViewUserProfile() {
        ...
        contentView.addSubview(imageViewUserGrade)
        imageViewUserGrade.snp.makeConstraints { make in
            make.centerY.equalTo(imageViewUserProfile).offset(11)
            make.centerX.equalTo(imageViewUserProfile)
        ...
        imageViewUser.snp.makeConstraints { make in
            make.centerX.equalTo(imageViewUserProfile.snp.centerX).offset(0)
            make.centerY.equalTo(imageViewUserProfile.snp.centerY).offset(-3)
    ...
    func setLabelUserLv() {
        ...
        labelUserLv.snp.makeConstraints { make in
            make.leading.equalTo(imageViewUserProfile.snp.trailing).offset(0)
