...
class DetailAnotherUserDataManager {
    func apiprofileuserIdxposts(_ viewcontroller : DetailAnotherUserViewController, _ userIdx : Int) {
        ...
        AF.request(Constant.TestURL + "/api/profile/\(userIdx)/posts", method: .get, headers: headers).validate().responseDecodable(of: DetailAnotherUserResult.self) { response in
