...
class SignInViewControllerDataManager {
    func appuserslogin(_ viewcontroller : SignInViewController, _ parameters : SignInViewControllerInput) {
        AF.request(Constant.TestURL + "/app/users/login", method: .post, parameters: parameters, encoder: JSONParameterEncoder.default).validate().responseDecodable(of: SignInViewControllerEntity.self) { response in
